...
export function useSession() {
  ...
  // A login with the password of the configuration (no username) carries no
  // account and has the rights of an admin - see api/auth.c and api/users.c
  // on the Lorentz side (is_admin() there follows the same rule).
