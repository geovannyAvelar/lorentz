...
*
*  Lorentz Engine
*  Lorentz syscall implementation for vsprintf
*
...
#undef vsprintf
int Lorentzvsprintf(const char *file, const char *func, const int line, char *__restrict__ buffer, const char *format, va_list args)
{
	// Sanity check
	if(buffer == NULL)
	{
