...
*
*  Lorentz Engine
*  Lorentz syscall implementation for fopen
*
...
#undef fopen
FILE * __attribute__ ((__malloc__)) Lorentzfopen(const char *pathname, const char *mode, const char *file, const char *func, const int line)
{
	FILE *file_ptr = 0;
	do
	{
